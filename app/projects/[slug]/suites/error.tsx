...
export default function SuitesError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-6 text-center">
      ...
      <h2 className="text-xl font-bold text-text-1">테스트 스위트를 불러올 수 없습니다</h2>
      <p className="max-w-md text-sm text-text-2">
        테스트 스위트 데이터를 불러오는 중 문제가 발생했습니다. 잠시 후 다시 시도해 주세요.
      </p>
