    ...
    <main className="bg-bg-1 text-text-1 flex min-h-screen w-full items-center justify-center px-4 font-sans">
      <div className="border-line-2 bg-bg-2 w-full max-w-md rounded-2xl border p-8">
        ...
        <input
          ...
          className="qa-file-input text-text-2 file:border-line-3 file:bg-bg-3 file:text-text-1 block w-full text-sm file:mr-3 file:rounded-md file:border file:px-3 file:py-2 file:text-sm"
        />
        ...
        <button
          ...
          className="qa-upload-submit bg-primary rounded-button h-button-md hover:bg-primary/90 active:bg-primary/80 mt-5 inline-flex items-center justify-center px-5 text-sm font-medium text-white transition-colors disabled:cursor-not-allowed disabled:opacity-50"
        >
          업로드
        </button>
