...
function transformRow(row: Record<string, string>, mapping: ColumnMapping): ImportRowInput {
  ...
  return {
    ...
    tags: tagsRaw
      ? tagsRaw
          ...
          .filter(Boolean)
      : undefined,
    preCondition: mapping.preCondition ? row[mapping.preCondition]?.trim() || undefined : undefined,
