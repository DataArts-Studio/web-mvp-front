    ...
    <ReactMarkdown
      ...
      components={{
        ...
        h2: ({ children }) => {
          ...
          return (
            <h2 id={id} className="typo-h2-heading text-text-1 mt-8 mb-4 scroll-mt-20">
              {children}
            </h2>
          );
        },
        h3: ({ children }) => {
          const id = slugify(getTextContent(children));
          return (
            <h3 id={id} className="typo-h3-heading text-text-1 mt-6 mb-3 scroll-mt-20">
              {children}
            </h3>
          );
        },
        ...
        blockquote: ({ children }) => (
          <blockquote className="border-primary text-text-3 my-4 border-l-4 pl-4 italic">
            {children}
          </blockquote>
        ),
      }}
