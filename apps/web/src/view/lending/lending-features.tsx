...
const faqs = [
  ...
  {
    question: '테스티아는 AI로 테스트 시나리오를 만들어 주나요?',
    answer:
      '네. 요구사항을 입력하면 테스티아 AI가 요구사항 분석서와 테스트 시나리오 초안을 생성합니다. 생성된 시나리오에서 바로 테스트 스위트와 케이스를 파생시킬 수 있어 QA 준비 시간을 크게 줄여줍니다.',
  },
  {
    question: '요구사항 기반으로 테스트를 관리할 수 있나요?',
    answer:
      '테스티아는 기능(요구사항) 단위로 테스트 시나리오를 묶어 관리합니다. 어떤 요구사항이 어떤 시나리오와 테스트 케이스로 검증되는지 추적할 수 있어 커버리지 관리에 유용합니다.',
  },
];
