...
export const ProjectInfoCard = ({ project, isCopied, onCopyLink }: ProjectInfoCardProps) => (
  <div
    className="rounded-3 border-line-2 bg-bg-2 flex flex-col gap-4 border p-5"
    data-tour="project-info"
  >
    ...
    <div className="rounded-2 bg-bg-3 flex flex-col items-center justify-center gap-2 p-4">
      <div className="flex items-center gap-2">
        <span className="typo-body2-heading text-primary max-w-50 truncate">{project?.name}</span>
        <button
          onClick={onCopyLink}
