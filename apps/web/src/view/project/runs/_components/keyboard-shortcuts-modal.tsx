...
export const KeyboardShortcutsModal = ({ open, onClose }: KeyboardShortcutsModalProps) => {
  ...
  return (
    ...
    >
      <div
        className="bg-bg-2 border-line-2 w-96 rounded-2xl border p-6 shadow-xl"
      ...
      >
        ...
        <button
          onClick={onClose}
          className="bg-primary hover:bg-primary/90 mt-6 w-full rounded-lg py-2 text-sm font-medium text-white transition-colors"
        >
          닫기
        </button>
      </div>
