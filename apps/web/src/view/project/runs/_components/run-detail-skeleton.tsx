...
export const RunDetailSkeleton = () => {
  return (
    <MainContainer className="flex min-h-screen flex-1 flex-col">
      ...
      <div className="sticky top-0 flex flex-1 overflow-hidden">
        <div className="border-line-2 flex w-[60%] flex-col border-r">
          ...
          {Array.from({ length: 10 }).map((_, i) => (
            <div
              key={i}
              className="border-line-2 flex items-center gap-3 border-b py-2.5 pr-3 pl-4"
            >
        ...
        <div className="flex w-[40%] flex-col">
          ...
          <div className="flex-1 px-5 py-3">
            ...
            <Skeleton className="mt-3 mb-2 h-3 w-16" />
