 ...
 *
 * pgEnum 으로 정의해 DB 레벨에서 'pdf' / 'markdown' 만 허용한다 (CodeRabbit PR #133 리뷰 분리).
 */
export const aiAttachedFileTypeEnum = pgEnum('ai_attached_file_type', ['pdf', 'markdown']);
export type AiAttachedFileType = (typeof aiAttachedFileTypeEnum.enumValues)[number];
